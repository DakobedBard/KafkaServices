...
//import org.mddarr.authentication.common.TimeProvider;
//import org.mddarr.authentication.model.Authority;
//import org.mddarr.authentication.model.User;
//import org.mddarr.authentication.model.UserRoleName;
//import org.mddarr.authentication.security.DeviceDummy;
...
//                .andExpect(content().json("{token:null,expires_in:null}"));
//    }
//
//    @Test
...
//                .andExpect(content().json("{token:" + refreshedToken + ",expires_in:100}"));
//    }
//
//    @Test
//    @WithMockUser(roles = "USER")
...
//        this.mvc.perform(post("/auth/refresh")
//                .header("Authorization", "Bearer " + token))
//                .andExpect(content().json("{token:" + refreshedToken + ",expires_in:200}"));
//    }
//
//    @Test
